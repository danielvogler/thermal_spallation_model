...
[Functions]
  ...
  [./my_image]
    type = ImageFunction
    #file_base = ../input_files/granite_images/granite00_01_10_11_
    file_base = ../../input_files/voronoi_diagrams/voronoi_lacDuBonnetGranite_EberhardEtAl1999noBounds5_noBoundary_full_
    file_suffix = png
    file_range = '00'
  [../]
  ###
  ...
  [./T_bc_top_func]
    ...
    data_file = ../../input_files/temperature_distributions/temperature_profile_gaussian_TMax800K_10sec.txt
  [../]
[]
...
[Outputs]
  ...
  interval = 2
  perf_graph = true
  file_base = ./lacDuBonnetGraniteEberhardEtAl1999_depth100m
[]
